...
def get_db():
    ...
    if _client is None:
        # URI simplificada
        MONGODB_URI = os.environ.get('MONGODB_URI', 'mongodb+srv://jorgelutz1:XHIz5HzUCo1cXJ7t@30daysofpython.e9nc9fv.mongodb.net/thirty_days_of_python?retryWrites=true&w=majority')
